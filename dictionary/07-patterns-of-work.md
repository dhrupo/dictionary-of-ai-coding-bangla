...
🧑‍🏫 "না, schema মাইগ্রেশন — human-in-the-loop রাখো। প্রতিটা স্টেপ দেখতে চাই, যাতে ভুল কলাম থেকে backfill করলে থামাতে পারি।"
...
প্রশ্ন: schema মাইগ্রেশনটা কি রাতভর AFK চালিয়ে দেব?
...
### AFK
🔊 *উচ্চারণ: এ-এফ-কে (Away From Keyboard)*
...
🧑‍🏫 "Typecheck আর lint যোগ করো — PR ল্যান্ড করার আগেই ওগুলো থেকে নিজে শুধরে নেবে।"
...
🧑‍🏫 "Merge-এর আগে একটা automated review স্টেপ যোগ করো — আলাদা মডেল, আলাদা সিস্টেম প্রম্পট, সিকিউরিটি ও কন্ট্রাক্ট বদলে স্কোপ করা।"
...
**উত্তর:** Merge-এর আগে একটা automated review স্টেপ — আলাদা মডেল, আলাদা সিস্টেম প্রম্পট।
...
🙋 "auth ফ্লোতে কী বদলেছে পড়ে দেখেছ?"

🧑‍🏫 "Vibe code করেছি — লগইন এখনো কাজ করছে, ওটুকুই চেক করেছি।"

🙋 "Push করার আগে ডিফ পড়ো — auth-এ ভাইব করাই গোপন তথ্য লগে লিক হওয়ার রাস্তা।"
...
🧑‍🏫 "তোমাদের design concept এখনো মেলেনি — ও ফাঁকগুলো নিজের অনুমানে ভরছে। cancellation, refund, partial fulfilment — সব দুজনের মধ্যে মিলে যাওয়া পর্যন্ত কথা বলো, তারপর [spec](05-handoffs.md#স্পেক-spec) লিখতে দাও।"
...
🧑‍🏫 "আগে grill করাও — partial cancel, refund, timing নিয়ে প্রশ্ন করিয়ে নাও, তারপর কিছু লিখতে দাও। কথায় ঠিক করা কোডে ঠিক করার চেয়ে সস্তা।"
...
**উত্তর:** আগে grill করানো — partial cancel, refund, timing নিয়ে প্রশ্ন করিয়ে নেওয়া।
...
<details>
<summary>🕵️ তুমি রাতভর AFK রান চালাবে আর সকালে দেখবে। কোয়ালিটি ঠিক রাখতে কোন শব্দগুলো কাজে লাগাবে?</summary>

- **Automated check** (test + typecheck + lint) — এজেন্ট নিজে শুধরাবে।
- **Automated review** — merge-এর আগে আলাদা এজেন্টের মতামত।
- সকালে **human review** — শুধু সারাংশ নয়, আসল ডিফ পড়ো!
- ঝুঁকির অংশে **vibe coding** এড়াও।
...
👉 **এবার কী করবে?** শব্দ শেখা শেষ — এবার কাজে লাগানোর পালা: [🎓 এরপর কী?](08-what-next.md)
